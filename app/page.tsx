        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Faizsiz finansman modeli prensiplerine uygun, şeffaf ve güvenilir
              finansman çözümleri ile ev ve araba sahibi olmanın en kolay yolu.
              Hemen hesaplayın, ödeme planı oluşturun ve hayallerinize ulaşın!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                asChild
                size="lg"
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-6 text-lg font-semibold rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:rotate-3"
              >
              ...
              <Button
                asChild
                size="lg"
                className="bg-red-500 hover:bg-red-600 text-white px-8 py-6 text-lg font-bold rounded-xl shadow-md hover:shadow-xl transition-all duration-500 transform hover:rotate-3"
              >
